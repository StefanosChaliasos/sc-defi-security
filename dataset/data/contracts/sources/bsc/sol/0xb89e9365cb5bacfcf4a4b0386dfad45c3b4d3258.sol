 ...
 */
abstract contract OwnerPausable is
    Ownable,
    Pausable
{
    /**
...
library SwapUtils {
    ...
    function swap(
        ...
        setBalances(self, dy, transferredDx, dyFee, tokenIndexTo, tokenIndexFrom);

        self.pooledTokens[tokenIndexTo].safeTransfer(to, dy);
     ...
     * @param self Swap struct to read from and write to
     * @param to The pool token receiver
    ...
    function removeLiquidity(
        ...
        for (uint256 i = 0; i < amounts.length; i++) {
            ...
            self.pooledTokens[i].safeTransfer(to, amounts[i]);
        }
    ...
    function removeLiquidityOneToken(
        ...
        self.pooledTokens[tokenIndex].safeTransfer(to, dy);
...
contract Swap is OwnerPausable, ReentrancyGuard {
     ...
     * @param to The swao token receiver
    ...
    function swap(
        ...
        returns (uint256)
    {
        return swapStorage.swap(to, tokenIndexFrom, tokenIndexTo, dx, minDy);
    }
    ...
    function addLiquidity(
        ...
        returns (uint256)
    {
        return swapStorage.addLiquidity(to, amounts, minToMint);
    }
    ...
    function removeLiquidity(
        ...
        return swapStorage.removeLiquidity(to, amount, minAmounts);
    }
    ...
    function removeLiquidityImbalance(
        ...
        returns (uint256)
    {
        return swapStorage.removeLiquidityImbalance(to, amounts, maxBurnAmount);
    }
